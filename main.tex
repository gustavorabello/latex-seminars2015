...
\input{abstracts/norbertoMangiavacchi}
\input{abstracts/rachelLucena}
\input{abstracts/leonMatos}
\input{abstracts/calilMeletti}
\input{abstracts/eduardoVitral}
\input{abstracts/cristianeFaria}
\input{abstracts/patriciaGomes}
\input{abstracts/americoCunha}
\input{abstracts/alcestesOliveira}
\input{abstracts/danielChalhub}
\input{abstracts/erikGros}
\input{abstracts/robsonNazareth}
\input{abstracts/rauniCoelho}
\input{abstracts/vinicioCoelho}
\input{abstracts/fabioSantos}
\input{abstracts/philippeBussetta}
\input{abstracts/jorgePeixinho}
...
%\includepdf[pages={1-2}]{../papers_pdf/44-45-seminario_fabio.pdf}
